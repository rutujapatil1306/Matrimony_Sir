...
//        user.setAddress(userDTO.getAddress());
    ...
    private void createUserProfile(User user, UserDTO userDTO) {
        ...
        userProfile.setDistrict("Not Specified"); 
        userProfile.setPinCode(000000); // Default pincode
        userProfile.setReligion("Not Specified"); 
        userProfile.setCaste("Not Specified"); 
        userProfile.setMaritalStatus("Single"); 
        userProfile.setHeight(150.0); // Default height in cm
        userProfile.setWeight(50); // Default weight in kg
        userProfile.setBloodGroup("Not Known"); 
        userProfile.setComplexion("Not Specified"); 
        userProfile.setDiet("Not Specified"); 
        userProfile.setSpectacle(false); 
        userProfile.setLens(false); 
        userProfile.setPhysicallyChallenged(false); 
        userProfile.setHomeTownDistrict("Not Specified"); 
        userProfile.setNativeTaluka("Not Specified"); 
        userProfile.setCurrentCity("Not Specified"); 
        
        userProfileRepository.save(userProfile);
        log.info("Created basic profile for user ID: {} - Profile completion required", user.getId());
    }
